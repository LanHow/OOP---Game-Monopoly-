...
#define DEFAULT_BG_COLOR	 RGB(181,255,181)	// 遊戲畫面預設的背景顏色(黑色)
...
namespace game_framework {
	...
	class CInteger {
	public:
		CInteger(int = 6);			// default 6 digits
	...
	public:
		...
		virtual void OnKetspace(UINT, UINT, UINT) {}
	...
	public:
		...
		void OnKeyspace(UINT, UINT, UINT);
